...
**Note:** Replace ```Jolita Grazyte``` ```JolitaGrazyte``` ```spatie.be``` ```jolita@spatie.be``` ```laravel-valuestore``` ```:Easily store some values``` with their correct values in [README.md](README.md), [CHANGELOG.md](CHANGELOG.md), [CONTRIBUTING.md](CONTRIBUTING.md), [LICENSE.md](LICENSE.md) and [composer.json](composer.json) files, then delete this line.
...
``` php
$skeleton = new Spatie\Valuestore();
